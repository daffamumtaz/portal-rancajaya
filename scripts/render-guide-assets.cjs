...
const sidebar = `
  <div class="side"><h3>Konten</h3>
    <div class="nav active">Berita & Informasi</div><div class="nav">Struktur Organisasi</div><div class="nav">Dusun</div>
    <div class="nav">Transparansi APBDes</div><div class="nav">Statistik Potensi</div><div class="nav">Kelompok Tani</div>
    <div class="nav">Produksi Pertanian</div><div class="nav">UMKM</div><div class="nav">Administrasi Daring</div>
    <div class="nav">Kontak</div><div class="nav">Galeri Foto</div><div class="nav">Pengaturan</div><div class="nav">Halaman Website</div>
  </div>`;
...
const pages = {
  ...
  'admin-apbdes.png': `<div class="shot"><div class="top"><div class="brand">Menulis di Transparansi APBDes</div><div class="btn">Terbitkan</div></div><div class="main"><h1>Pos APBDes</h1><div class="editor"><div class="form"><div class="field"><label>NAMA SUMBER ATAU POS</label><div class="input"></div></div><div class="field"><label>JENIS - PENDAPATAN / BELANJA</label><div class="input"></div></div><div class="field"><label>TAHUN ANGGARAN</label><div class="input"></div></div><div class="field"><label>VERSI APBDES - AWAL / PERUBAHAN</label><div class="input"></div></div><div class="field"><label>JUMLAH RUPIAH</label><div class="input"></div></div><div class="field"><label>SUMBER DATA</label><div class="input"></div></div></div><div class="preview"><h2>Ringkasan pos</h2><div class="line short"></div><div class="line"></div><div class="line"></div><div class="line short"></div></div></div></div></div>`,
  'admin-media.png': `<div class="shot"><div class="top"><div class="brand">Aset Media</div><div class="status">Portal Rancajaya</div></div><div class="main"><h1>Unggah gambar</h1><div class="drop">Pilih gambar dari komputer<br><span class="muted">Gunakan JPG, PNG, atau WebP dan nama berkas yang jelas</span></div><div class="thumbs"><div class="thumb"></div><div class="thumb"></div><div class="thumb"></div><div class="thumb"></div></div></div></div>`,
  'arsitektur-portal.png': `<div class="shot"><div class="top"><div class="brand">Alur Teknis Portal Rancajaya</div><div class="status">Astro + Decap CMS + GitHub Pages</div></div><div class="flow"><div class="node">Pengelola<small>mengubah konten melalui halaman admin</small></div><div class="arrow">→</div><div class="node">Decap CMS<small>menulis berkas ke branch main</small></div><div class="arrow">→</div><div class="node">GitHub Actions<small>menjalankan npm ci dan npm run build</small></div><div class="arrow">→</div><div class="node">GitHub Pages<small>menyajikan hasil folder dist</small></div></div></div>`
};
